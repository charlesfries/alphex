...
$asks_total = get_asks_total();
$asks_total = number_format($asks_total, 8, ".", "");
?>
<small class="text-muted hover-right">Total: <?=htmlspecialchars($asks_total)?> <?=htmlspecialchars($coin_1)?></small>
